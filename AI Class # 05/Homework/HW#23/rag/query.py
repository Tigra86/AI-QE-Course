...
# -----------------------------
# Auto-rules: separate files (Option C)
# -----------------------------
...
auto_specs = {}        # product -> answers
auto_comparisons = {}  # "a vs b" -> answers
...
def load_auto_rules():
    ...
    # merge into main rules["product_specs"]
...
# -----------------------------
# Inference with auto-gen + persistence
# -----------------------------
def infer(question: str):
    ...
    # 2. Simple spec detection (e.g. "Fenix 8 specs")
